...
function Products() {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            setError(err?.message || (isEnglish ? 'Failed to delete.' : 'حذف انجام نشد.'));
            setDeletingProduct(null);
        } finally {
            setDeleting(false);
        }
...
function DeleteConfirm({ product, loading, isEnglish, t, onCancel, onConfirm }) {
    ...
    return (
        <div
            ...
            style={{
                background: 'radial-gradient(circle at 50% 50%, rgba(0,0,0,0.45), rgba(0,0,0,0.62))',
            }}
        >
                    ...
                    <div className="min-w-0">
                        <h3 className="text-sm font-semibold text-[var(--text)]">
                            {t('products.delete.title', {
                                defaultValue: isEnglish ? 'Delete product' : 'حذف محصول',
                            })}
                        </h3>

...
function QuickActions() {
    ...
    const actions = useMemo(() => [
        { id: 'new-sale', title: t('dashboard.quickActions.newSale.title'), description: t('dashboard.quickActions.newSale.description'), icon: Plus, tone: 'accent', href: '/sales' },
        { id: 'shopping-list', title: t('dashboard.quickActions.shoppingList.title'), description: t('dashboard.quickActions.shoppingList.description'), icon: ShoppingCart, tone: 'violet', href: '/shopping-list' },
        { id: 'credit-sale', title: t('dashboard.quickActions.creditSale.title'), description: t('dashboard.quickActions.creditSale.description'), icon: CreditCard, tone: 'warning', href: '/credit-sales' },
        { id: 'reports', title: t('dashboard.quickActions.reports.title'), description: t('dashboard.quickActions.reports.description'), icon: BarChart3, tone: 'cyan', href: '/reports' },
    ], [t]);
                        ...
                        >
                            ...
                            <div className="relative z-10 flex items-start justify-between gap-3">
                                ...
                                <ArrowLeft
                                    size={16}
                                    strokeWidth={1.8}
                                    className={`shrink-0 opacity-0 transition-all duration-300 ${isRTL ? '-translate-x-1' : 'translate-x-1 rotate-180'} group-hover:translate-x-0 group-hover:opacity-100 ${tone.iconText}`}
                                />
                            </div>

                            ...
                            <>
                                ...
                                <span
                                    className={`
                                        ...
                                        ${
                                            isEnglish
                                                ? 'left-[3px] rounded-full'
                                                : 'right-[3px] rounded-full'
                                        }
        ...
        <>
            ...
            <aside
                className={`
                    ...
                    transition-[width,transform,background-color,border-color,box-shadow]
                    duration-300
            ...
            >
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            transition:
                                'transform 300ms var(--ease-out), border-color 220ms var(--ease-out), color 220ms var(--ease-out), background 220ms var(--ease-out), box-shadow 220ms var(--ease-out)',
                        }}
                        ...
                        style={{
                            background: `
                                linear-gradient(
                                    90deg,
                                    transparent 0%,
                                    var(--accent-soft-strong) 20%,
                                    var(--border) 50%,
                                    var(--accent-soft-strong) 80%,
                                    transparent 100%
                                )
                            `,
                        }}
                        ...
                        style={{
                            background: `
                                linear-gradient(
                                    90deg,
                                    transparent 0%,
                                    var(--accent-soft-strong) 25%,
                                    var(--border) 50%,
                                    var(--accent-soft-strong) 75%,
                                    transparent 100%
                                )
                            `,
                        }}
                    ...
                    <button
                        ...
                        onMouseEnter={(event) => {
                            ...
                            event.currentTarget.style.boxShadow =
                                '0 8px 26px rgba(239, 68, 68, 0.20)';

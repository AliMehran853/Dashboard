...
function AnimatedNumber({ value, language, decimals = 0, className, dir }) {
...
function ShoppingListStats({ items = [] }) {
    ...
    const statItems = [
        {
            id: 'total',
            label: t('shoppingList.stats.total', {
                defaultValue: isEnglish ? 'Total Items' : 'مجموع اقلام',
            }),
        ...
        {
            id: 'pending',
            label: t('shoppingList.stats.pending', {
                defaultValue: isEnglish ? 'Pending' : 'در انتظار',
            }),
        ...
        {
            id: 'completed',
            label: t('shoppingList.stats.completed', {
                defaultValue: isEnglish ? 'Completed' : 'تکمیل‌شده',
            }),
                    ...
                    return (
                        ...
                        >
                            <div className="ui-layer flex min-w-0 items-start justify-between gap-4">
                                ...
                                <div
                                    className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border transition-transform duration-300 group-hover:scale-105 sm:h-11 sm:w-11 ${stat.iconBg}`}
                                >
